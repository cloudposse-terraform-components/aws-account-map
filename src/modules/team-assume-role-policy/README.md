...
| <a name="input_permission_set_arn_like_role_prefix"></a> [permission\_set\_arn\_like\_role\_prefix](#input\_permission\_set\_arn\_like\_role\_prefix) | The prefix used to generate the role part of the AWS SSO PermissionSet ARN pattern.<br/>The default value is explicit, but does not distinguish between regions.<br/>You may want a shorter prefix if trust policies are too large. You may want<br/>a longer prefix if you are concerned about IdPs in other regions. | `string` | `null` | no |
