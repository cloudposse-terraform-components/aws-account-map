...
| <a name="input_overridable_global_environment_name"></a> [overridable\_global\_environment\_name](#input\_overridable\_global\_environment\_name) | Global environment name | `string` | `"gbl"` | no |
